...
{
    public interface ITipoRechazoRepository : IRepository<TipoRechazo>
    {
        Task<TipoRechazo?> GetByIdAsync(int id);
        Task<System.Collections.Generic.List<TipoRechazo>> GetAllAsync(System.Threading.CancellationToken cancellationToken = default);
    }
}
