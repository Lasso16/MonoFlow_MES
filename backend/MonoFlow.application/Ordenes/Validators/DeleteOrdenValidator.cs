...
{
    public class DeleteOrdenValidator : ICommandValidator<DeleteOrdenCommand>
    {
        public Task<CommandResult> ValidateAsync(DeleteOrdenCommand request, CancellationToken cancellationToken = default)
        {
